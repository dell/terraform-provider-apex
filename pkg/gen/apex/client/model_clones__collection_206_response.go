...
// checks if the ClonesCollection206Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClonesCollection206Response{}
...
func NewClonesCollection206Response() *ClonesCollection206Response {
	this := ClonesCollection206Response{}
	return &this
}
...
type NullableClonesCollection206Response struct {
	value *ClonesCollection206Response
	isSet bool
}

func (v NullableClonesCollection206Response) Get() *ClonesCollection206Response {
	return v.value
}

func (v *NullableClonesCollection206Response) Set(val *ClonesCollection206Response) {
	v.value = val
	v.isSet = true
}

func (v NullableClonesCollection206Response) IsSet() bool {
	return v.isSet
}

func (v *NullableClonesCollection206Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClonesCollection206Response(val *ClonesCollection206Response) *NullableClonesCollection206Response {
	return &NullableClonesCollection206Response{value: val, isSet: true}
}
