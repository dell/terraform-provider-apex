...
func TestTerraformResourceBlockStorageCloud(t *testing.T) {
	t.Parallel()

	terraformOptions := terraform.WithDefaultRetryableErrors(t, &terraform.Options{
		// Set the path to the Terraform code that will be tested.
		// The path to where our Terraform code is located
		TerraformDir: "../../../../examples/tests/block_storage/block_storage_cloud",
	})

	terraformRemoveOptions := terraform.WithDefaultRetryableErrors(t, &terraform.Options{
		// Set the path to the Terraform code that will be tested.
		// The path to where our Terraform code is located
		TerraformDir: "../../../../examples/tests/block_storage/remove",
	})
