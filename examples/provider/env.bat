...
set APEX_SAML_TOKEN_SCRIPT_DIR="./scripts/saml_script"
:: Python SAML script to run when we need to get a new SAML token.
set APEX_SAML_TOKEN_SCRIPT_NAME="saml_get_okta_token.py"
...
set APEX_DI_TOKEN_URL="https://www.dell.com/di/v3/fp/oauth/token"
