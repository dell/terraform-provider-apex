...
// checks if the UpdateCloneInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCloneInput{}
...
type NullableUpdateCloneInput struct {
	value *UpdateCloneInput
	isSet bool
}

func (v NullableUpdateCloneInput) Get() *UpdateCloneInput {
	return v.value
}

func (v *NullableUpdateCloneInput) Set(val *UpdateCloneInput) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdateCloneInput(val *UpdateCloneInput) *NullableUpdateCloneInput {
	return &NullableUpdateCloneInput{value: val, isSet: true}
}
