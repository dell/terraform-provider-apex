...
// checks if the MobilityTargetsCollection206Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MobilityTargetsCollection206Response{}
...
func NewMobilityTargetsCollection206Response() *MobilityTargetsCollection206Response {
	this := MobilityTargetsCollection206Response{}
	return &this
}
...
type NullableMobilityTargetsCollection206Response struct {
	value *MobilityTargetsCollection206Response
	isSet bool
}

func (v NullableMobilityTargetsCollection206Response) Get() *MobilityTargetsCollection206Response {
	return v.value
}

func (v *NullableMobilityTargetsCollection206Response) Set(val *MobilityTargetsCollection206Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMobilityTargetsCollection206Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMobilityTargetsCollection206Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobilityTargetsCollection206Response(val *MobilityTargetsCollection206Response) *NullableMobilityTargetsCollection206Response {
	return &NullableMobilityTargetsCollection206Response{value: val, isSet: true}
}

func (v NullableMobilityTargetsCollection206Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobilityTargetsCollection206Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
