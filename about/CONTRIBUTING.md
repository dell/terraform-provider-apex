...
* Contribute to the Terraform provider for Dell PowerStore documentation and codebase.
...
We aim to track and document everything related to Terraform provider for Dell PowerStore via the Issues page. The code and documentation are released with no warranties or SLAs and are intended to be supported through a community driven process.
...
We'd love your help answering questions being asked by other Terraform provider for Dell PowerStore users.
...
If you don't have the knowledge or time to code, consider helping with _issue triage_. The Terraform provider for Dell PowerStore community will thank you for saving them time by spending some of yours.
...
Terraform provider for Dell PowerStore uses the guidelines for commit messages outlined in [How to Write a Git Commit Message](https://chris.beams.io/posts/git-commit/)
...
[GitHub action](https://github.com/dell/terraform-provider-powerstore/actions/workflows/ansible-test.yml) that analyzes source code to flag ansible sanity errors and runs Unit tests.
